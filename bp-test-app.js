...
// ======================================================
// Brand/Product selections cannot have Expected rows.
// Expected rows are store-level only and normally have
// no brand associated with them.
//
// If a brand is selected:
//   - Disable Expected
//   - If user was on Expected, switch to All statuses
//
...
async function init() {
  ...
  $('storeFilter')?.addEventListener('change', renderAllocation);
  ...
  $('trackerStatusFilter')?.addEventListener('change', renderAllocation);
